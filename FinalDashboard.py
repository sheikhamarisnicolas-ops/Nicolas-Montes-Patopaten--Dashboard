...
st.markdown(f"""
    <div style="text-align:center; padding: 40px; color:white; border-top: 1px solid {TEXT_SOFT}; margin-top:50px;">
        ...
        <p><b>Dataset Credit:</b> <a href="https://www.kaggle.com/datasets/mikhail1681/walmart-sales" style="color: {W_YELLOW};">Walmart Sales Dataset via Kaggle (Mikhail1681)</a></p>
        <p>© 2026 Business Analytics Project • Information Systems </p>
